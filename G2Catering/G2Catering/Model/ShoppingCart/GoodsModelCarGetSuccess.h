...
@interface GoodsModelCarGetSuccess : NSObject
...
@property (nonatomic,copy)NSString *attribute13;
@property (nonatomic,copy)NSString *payType;
@property (nonatomic,copy)NSString *supplierName;
@property (nonatomic,copy)NSString *attribute8;
@property (nonatomic,copy)NSString *limit;
@property (nonatomic,copy)NSString *attribute12;
@property (nonatomic,copy)NSString *attribute19;
...
@property (nonatomic,copy)NSString *attribute17;
