...
#define FSCalendarStandardSelectionColor    FSColorRGBA(42,66,90,1.0) //FSColorRGBA(31,119,219,1.0)  //选中的背景颜色
#define FSCalendarStandardTodayColor      FSColorRGBA(198,51,42 ,1.0) //当天的颜色
#define FSCalendarStandardTitleTextColor  FSColorRGBA(42,66,90,1.0) //14,69,221 ,1.0
#define FSCalendarStandardEventDotColor   FSColorRGBA(42,66,90,0.75)
